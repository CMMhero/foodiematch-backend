...
def get_recommendations_v2(user_id, user_lat, user_lon, num_recommendations=10):
    # Get tables
...
@app.route('/recommendv2')
def recommendv2():
    user_id = request.args.get('id')
    user_lat = float(request.args.get('lat'))
    user_lon = float(request.args.get('lon'))
    num_recommendations = int(request.args.get('num', 10))
    recommendations = get_recommendations_v2(user_id, user_lat, user_lon, num_recommendations)
